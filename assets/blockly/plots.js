...
var addPlot = function(plotType){
	plotwidgets = $('#resultplots');
	$('#resultplots').addClass('visible');
	
	saveButton = $('<button>').text('Save').click(dumpToDisc);
	plotwidgets.prepend(saveButton);
...
var addPolarPlot = function(container){
polarPositions = [];
container.addClass('visible');

saveButton = $('<button>').text('Save').click(dumpToDisc);
container.prepend(saveButton);


container.append(`
<div id="polarplot" style="width:auto;height:100%;">
<!-- Grey circle -->
...
plt = document.querySelector('.circle'); 
